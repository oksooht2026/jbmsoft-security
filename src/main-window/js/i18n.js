...
const translations = {
  ko: {
    ...
    stat_pending: "승인 대기",
    stat_mail_guard: "메일 감시",
    stat_usb_guard: "USB 차단",
    stat_today: "오늘",
    ...
    ap_sub: "관리자 승인 요청·처리 결과를 확인합니다 (승인/거부는 관리자 웹에서만 가능)",
    ap_all: "전체",
    ap_pending: "대기 중",
    ap_approved: "승인됨",
    ap_rejected: "거부됨",
  ...
  en: {
    ...
    stat_mail_guard: "Mail Monitor",
    stat_usb_guard: "USB Block",
    stat_today: "today",
    ...
    fs_clipboard: "Clipboard Block",
    fs_clipboard_desc: "Blocks file copy to clipboard operations",
    fs_file_guard: "Real-time File Monitor",
    ...
    fs_print_guard: "Screen Capture Monitor",
    fs_print_guard_desc: "Warn when screenshot or screen recording apps are detected",
    fs_ext_title: "Monitored File Types",
    fs_ext_desc: "Set file extensions to monitor",
    ...
    net_mail_guard: "Mail Transmission Record",
    net_mail_guard_desc: "Monitor and record external mail (SMTP) and webmail activities",
    net_cloud_block: "Cloud Upload Block",
    ...
    ap_sub: "View approval requests and results (approve/reject only on admin web)",
    ap_all: "All",
    ap_pending: "Pending",
